  ...
  <div class="admin-all-settings">
    <ul class="admin-all-settings__grid">
            ...
            <main class="admin-settings-row__main">
              <div class="admin-settings-row__input">
                <input
                  ...
                  :class="{
                    '--th-error':
                      v$.form.size?.$each.$response.$errors[index].value
                        .length > 0,
                  }"
                />
              </div>
      ...
      <AdminBlockBase title="Тип края">
        <ul class="admin-settings-options">
          <li
            class="admin-settings-row --th-types"
            ...
            <main class="admin-settings-row__main">
              <div class="admin-settings-row__input">
                <input
                  ...
                  :class="{
                    '--th-error':
                      v$.form.types?.$each.$response.$errors[index].value
                        .length > 0,
                  }"
                />
              </div>
            ...
            <main class="admin-settings-row__main">
              <div class="admin-settings-row__input">
                <input
                  ...
                  :class="{
                    '--th-error':
                      v$.form.categories?.$each.$response.$errors[index].value
                        .length > 0,
                  }"
                />
              </div>
    ...
    <footer class="admin-all-settings__footer">
      <ul class="admin-all-settings__actions">
        <li class="admin-all-settings__action">
          <UIButton @click="save" :styles="['sz-base', 'th-orange']"
            >Сохранить</UIButton
          >
        </li>
      </ul>
