      ...
      <template v-if="!isStateEdit">
        ...
        <button @click="deleteProduct" class="admin-product-card__btn-top">
          <svg  viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            <path d="M256 506C394.071 506 506 394.071 506 256C506 117.929 394.071 6 256 6C117.929 6 6 117.929 6 256C6 394.071 117.929 506 256 506Z" fill="red"/>
            <path d="M378.7 134.3H298.1V120C298.1 112.3 291.8 106 284.1 106H228C220.3 106 214 112.3 214 120V134.2H133.4C129.5 134.2 126.3 137.4 126.3 141.3C126.3 145.2 129.5 148.4 133.4 148.4H146.5L155.4 380.7C155.9 394.9 167.5 406.1 181.7 406.1H330.4C344.6 406.1 356.2 395 356.7 380.7L365.6 148.4H378.7C382.6 148.4 385.8 145.2 385.8 141.3C385.8 137.4 382.6 134.3 378.7 134.3ZM228 120.1H284V134.2H228V120.1ZM342.6 380.1C342.3 386.7 337 391.9 330.4 391.9H181.6C175 391.9 169.6 386.7 169.4 380.1L160.5 148.4H351.5L342.6 380.1Z" fill="white"/>
            <path d="M205.999 205.5H205.899C201.999 205.6 198.899 208.8 198.999 212.7L201.199 327.9C201.299 331.8 204.399 334.8 208.299 334.8H208.399C212.299 334.7 215.399 331.5 215.299 327.6L212.999 212.4C212.899 208.5 209.799 205.5 205.999 205.5Z" fill="white"/>
            <path d="M255.999 205.5C252.099 205.5 248.899 208.7 248.899 212.6V327.8C248.899 331.7 252.099 334.9 255.999 334.9C259.899 334.9 263.099 331.7 263.099 327.8V212.5C263.099 208.6 259.899 205.5 255.999 205.5Z" fill="white"/>
            <path d="M303.7 334.8H303.8C307.6 334.8 310.8 331.7 310.9 327.9L313.1 212.7C313.2 208.8 310.1 205.6 306.2 205.5C302.3 205.4 299.1 208.5 299 212.4L296.8 327.6C296.7 331.5 299.8 334.7 303.7 334.8Z" fill="white"/>
          </svg>
        </button>
      </template>
