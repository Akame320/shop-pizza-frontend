<template>
  <li class="basket-item-row">
    <main class="basket-item-row__main">
      <div class="basket-item-row__img-wrapper">
        <img class="basket-item-row__img" :src="img" alt="">
      </div>
    ...
    <aside class="basket-item-row__aside">
      <div class="basket-item-row__counts">
        <div class="basket-item-row-counts">
          <div class="basket-item-row-counts__btn">
            <button @click="$emit('decrement', product.id)" class="circle-button">
          ...
          <span class="basket-item-row-counts__elem">{{ product.count }}</span>
          <div class="basket-item-row-counts__btn">
            <button @click="$emit('increment', product.id)" class="circle-button">
