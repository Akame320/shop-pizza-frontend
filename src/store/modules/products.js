...
const mutations = {
  ...
  BASK_PRODUCT_INCREMENT: (state, payload) => {
    ...
    searchedItem.price =
      (searchedItem.size.price + searchedItem.type.price) * searchedItem.count;
  },
  ...
  BASK_PRODUCT_UPDATE: (state, payload) => {
    ...
    searchedItem.price =
      (payload.size.price + payload.type.price) * searchedItem.count;
  },

  BASKET_PRODUCT_CLEAR: (state, payload) => {
    const searchedItemIndex = state.basket.findIndex(
